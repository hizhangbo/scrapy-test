...
from plantomjsTest.items import PlantomjstestItem

class WeiboSpider(scrapy.Spider):
    name = 'weibo'
    allowed_domains = ['s.weibo.com']
    start_urls = ["http://s.weibo.com/weibo/{}&nodup=1".format(parse.quote_plus(parse.quote_plus('key words')))]
